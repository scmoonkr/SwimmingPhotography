...
// 선수(Athletes1) — athletes.vue 의 작업 복사본. 기존 athletes 는 보존하고,
// 여기서 '기계적 규칙 + LLM' 하이브리드 기사 생성을 실험한다. API 는 /api/athletes1.
import { computed, onMounted, ref, watch } from 'vue'
import type { Column, Field } from '~/composables/useMock'

const api = (p = '') => `${useRuntimeConfig().public.apiBase}/api/athletes1${p}`
